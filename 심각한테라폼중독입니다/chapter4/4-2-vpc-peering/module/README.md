...
|------|-------------|------|---------|:--------:|
| <a name="input_accepter_vpc"></a> [accepter\_vpc](#input\_accepter\_vpc) | Accepter VPC Info | <pre>object({<br>    vpc_id               = string<br>    vpc_name             = string<br>    allow_dns_resolution = optional(bool, true)<br>  })</pre> | n/a | yes |
| <a name="input_requester_vpc"></a> [requester\_vpc](#input\_requester\_vpc) | Requester VPC Info | <pre>object({<br>    vpc_id               = string<br>    vpc_name             = string<br>    allow_dns_resolution = optional(bool, true)<br>  })</pre> | n/a | yes |
